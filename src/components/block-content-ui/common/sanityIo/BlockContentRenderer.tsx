...
export const abBlockSerializers: any = {
    ...
    marks: {
        ...
        primaryTextColor: (props: any) => (TextColorRender(props, TheWebsiteTheme
            .palette.primary.main)),
        secondaryTextColor: (props: any) => (TextColorRender(props, TheWebsiteTheme
            .palette.secondary.main)),
        accentTextBlue: (props: any) => (TextColorRender(props, '#565190')),
        accentTextGreen: (props: any) => (TextColorRender(props, '#5C7F61')),
        underlinePrimaryColor: (props: any) => (UnderlineRender(props, TheWebsiteTheme
            .palette.primary.main)),
        ...
        backgroundHighlightPeach: (props: any) => HighlightRender(props, TheWebsiteTheme
