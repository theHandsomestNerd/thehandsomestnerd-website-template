    ...
    <Grid container data-testid='add-ball-basic-info-step' direction='column' spacing={2}>
      <Grid container item>
        <Grid item>
          ...
          <Typography variant='h5' color='textSecondary'>What type of ball do you wish to add?</Typography>
        </Grid>
        <Grid item>
          <Typography
            style={{paddingLeft: theme.spacing(2)}}
            variant='h5' data-testid='ball-type-choice' align='center'
            color='primary'>{renderBallType()}</Typography>
        </Grid>
      </Grid>
      <Grid container item spacing={3} style={{paddingTop: theme.spacing(2.25), height: '450px'}}>

        <Grid container item><Typography variant='h6' style={{textTransform: 'uppercase'}} color='textSecondary'>Choose
          the type of ball below:</Typography></Grid>
        <Grid container item spacing={2}>
          <Grid container item alignItems='center' justifyContent='space-around' direction='column' spacing={2}>
          ...
          <Grid container item alignItems='center' justifyContent='space-around' direction='column' spacing={2}>
            ...
            <Grid container item xs={6}>
              <Button
                ...
                color='primary'
                onClick={() => setActiveBallType(BallTypeEnum.MINI_BALL_DELUXE)}>Mini-Ball Deluxe</Button>
            </Grid>
          </Grid>
        </Grid>
      </Grid>
