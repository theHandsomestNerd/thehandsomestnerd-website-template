        ...
        <Grid container item className={classes.root} xs={12} alignItems='center'>
            ...
            <Grid item container justifyContent='center' spacing={2} px={4}>
                {props.sectionData.servicesList?.map((service: AnimatedServiceItemNoRefType, index: number) => {
                    return <Grid item xs={12} sm={5} md={4} key={index} container
                                 justifyContent='center'><AnimatedAboutUsItem service={service}/></Grid>
                })}
            </Grid>
            <Grid item container style={{padding: theme.spacing(8, 6)}}
                ...
                <Grid item container xs={12} sm={12} md={6}><Grid item container xs={12}>
                    <Grid item container>
                        <BulletedHeader textContent={props.sectionData?.contentPreTitle}
                    ...
                    <Grid item container style={{paddingBottom: "32px"}} spacing={2}>
                        {props.sectionData.highlightedAmenities?.map((amenity: ServiceAmenityType, index: number) => {
                            return <Grid container item key={index} xs={12} sm={6}><HorizontalAmenity
                                amenity={amenity}/></Grid>
                        })}
                    </Grid>
                    <Grid item container>
                    ...
                    <Grid container item spacing={1} style={{position: "relative"}}>
                                ...
                                <Grid item>
                                    ...
                                    >
                                        ...
                                        <img
                                            width={64}
                                            height={64}
                                            src={sanityContext.placeholderOrImage && sanityContext.placeholderOrImage(props.sectionData?.servicesMasonryAccentImageSrc, 64,64)}
                                        />
                                    </motion.div>
                                </Grid>
                                {/*</Card>*/}
                        ...
                        }
                        {
                            ...
                            <Grid item container justifyContent='center' alignContent='flex-end' alignItems='flex-end'>
                                <Grid item>
                                    <img
                                        src={sanityContext.placeholderOrImage && sanityContext.placeholderOrImage(props.sectionData?.servicesImageSrcArr[0], 485, 356)}/>
                                </Grid>
                            </Grid>
                        }
                        {
                            ...
                            <Grid item container justifyContent='center' spacing={2}>
                                <Grid item xs={6} container justifyContent='flex-end'>
                                    <Grid item><img
                                        src={sanityContext.placeholderOrImage && sanityContext.placeholderOrImage(props.sectionData?.servicesImageSrcArr[1],230,265)}/></Grid>
                                </Grid>
                                <Grid item xs={6}>
                                    <Grid item>
                                        <img
                                            style={{maxWidth: "100%"}}
                                            src={sanityContext.placeholderOrImage && sanityContext.placeholderOrImage(props.sectionData?.servicesImageSrcArr[2], 260, 305)}/></Grid>
                                </Grid>
                            </Grid>
                        }
