import {ResumeEducationSectionType} from "../../components/BlockContentTypes";

const ResumeEducationSectionData:ResumeEducationSectionType = {
    "name": "Education",
...
export default ResumeEducationSectionData