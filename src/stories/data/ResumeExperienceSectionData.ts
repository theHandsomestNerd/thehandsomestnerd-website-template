import {ResumeExperienceSectionType} from "../../components/BlockContentTypes";

const ResumeExperienceSectionData:ResumeExperienceSectionType = {
...
export default ResumeExperienceSectionData