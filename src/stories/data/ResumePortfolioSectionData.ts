import {ResumePortfolioSectionType} from "../../components/BlockContentTypes";

const ResumePortfolioSectionData:ResumePortfolioSectionType = {
    "portfolioEntries": [
        {
...
export default ResumePortfolioSectionData