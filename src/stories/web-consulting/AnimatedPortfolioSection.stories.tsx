...
const meta: Meta<typeof AnimatedPortfolioSection> = {
    title: "Web Consulting/Portfolio Section",
    component: AnimatedPortfolioSection,
};

export default meta;
type Story = StoryObj<typeof AnimatedPortfolioSection>;
...
export const AnimatedPortfolioSectionComplete: Story = {
    ...
    render: ({sectionData,}) =>
        <ThemeProvider theme={getThemeFromSanity(WebConsultingThemeData)}>
            <AnimatedPortfolioSection sectionData={sectionData}></AnimatedPortfolioSection>
        </ThemeProvider>,
};
