...
import AppSettingsContext from "../../components/templates/anybody-walking/app-settings/AppSettingsContext";
...
const meta: Meta<typeof ViewChange> = {
    title: "Anybody Walking/Components/Ball Search View Selector",
...
export const AWViewChangeComplete: Story = {
    ...
    render: () =>
        <AppSettingsProvider><BallSearchProvider balls={AwBallsArrayData}>
            <ThemeProvider
                theme={getThemeFromSanity(AWThemeData)}>
                <ViewChange />
            </ThemeProvider>
        </BallSearchProvider></AppSettingsProvider>
};