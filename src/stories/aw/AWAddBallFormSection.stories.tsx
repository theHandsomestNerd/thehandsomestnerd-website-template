...
import AWAddBallFormSection from "../../components/templates/anybody-walking/AWAddBallFormSection";
import AwSingleBallData from "../data/AwSingleBallData";

const meta: Meta<typeof AWBallsSearchSection> = {
    title: "Anybody Walking/Add Ball Form Section",
...
export const AWBallsSearchSectionComplete: Story = {
    ...
    render: ({sectionData}) =>
        <AppSettingsProvider settings={settings}><ThemeProvider
            ...
            <AWAddBallFormSection sectionData={sectionData}/>
