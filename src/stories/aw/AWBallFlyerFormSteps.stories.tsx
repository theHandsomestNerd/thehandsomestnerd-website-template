...
const meta: Meta<typeof AddBallFlyer> = {
    title: "Anybody Walking/Steps/Ball Flyer",
    component: AddBallFlyer,
};

export default meta;
type Story = StoryObj<typeof AddBallFlyer>;
...
export const AWAddBallFlyerComplete: Story = {
    args: {
    ...
    render: ({}) =>
        <BallSearchProvider balls={AwBallsArrayData}>
            <ThemeProvider
                ...
                <AddBallFlyer stepComplete={()=>{}} newBallToAdd={{ballType: BallTypeEnum.BALL, }}/>
            </ThemeProvider>
        </BallSearchProvider>
};